...
let current_users: string[] = ["numan", "usman", "malik", "umair", "talha"];
let new_users: string[] = ["NUMAN", "bilal", "salman", "malik", "umar"];
...
let pizzaNames: string[] = ["Pepperoni", "Chicken Tikka", "BBQ Chicken"];
...
const magicianNames: string[] = ["John", "Harry", "Teller", "Dynamo"];
...
const make_great = (magicians: string[]): string[] => {
  const modifiedMagicians: string[] = magicians.map((i) => {
    console.log(`The Great ${i}`);
    return `The Great ${i}`;
  });
  return modifiedMagicians;
};
const modifiedMagicians: string[] = make_great(magicianNames);
console.log(
  "🚀 ~ file: task32to45.ts:166 ~ modifiedMagicians:",
  modifiedMagicians
);
